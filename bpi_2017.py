...
def main():
    ...
    logs = construct.subdivide_log(
        'pm4py/statistics/time_series/experiments/data/BPI.xes',
    ...
    res = cause_effect.granger_causality(primary_names,primary_features, secondary_features,
                                        secondary_names, cp_1, cp_2,
                                        p_value = 0.015)
    for i in secondary_names:
        print(i)     
    print(len(res))
    cause_effect.draw_ca(res,pdf_path="bpi_2017.pdf")
